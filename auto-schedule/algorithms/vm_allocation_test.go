	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedResult: models.IaasVm{
				Name:    "auto-sched-nokia4-1",
				Cloud:   "NOKIA4",
				VCpu:    models.CalcVmTotalVcpu(1.4 + 4.0 + 3.0),
				Ram:     models.CalcVmTotalRamMiB(990 + 990 + 540),
				Storage: models.CalcVmTotalStorGiB(15 + 15 + 35),
			},
		},
		{
			name:     "case2",
			...
			expectedResult: models.IaasVm{
				Name:    "auto-sched-nokia4-0",
				Cloud:   "NOKIA4",
				VCpu:    models.CalcVmTotalVcpu(5.0 + 5.0 + 2.0),
				Ram:     models.CalcVmTotalRamMiB(660 + 990 + 540),
				Storage: models.CalcVmTotalStorGiB(6 + 15 + 15),
			},
		},
	}
		...
		testCases = append(testCases, caseStruct{
			...
			expectedVms: []models.IaasVm{
				models.IaasVm{
					Name:    "auto-sched-nokia4-1",
					Cloud:   "NOKIA4",
					VCpu:    models.CalcVmTotalVcpu(2.4 + 1.4 + 5.0),
					Ram:     models.CalcVmTotalRamMiB(1024 + 990 + 660),
					Storage: models.CalcVmTotalStorGiB(10 + 15 + 6),
				},
				models.IaasVm{
					Name:    "auto-sched-nokia4-2",
					Cloud:   "NOKIA4",
					VCpu:    models.CalcVmTotalVcpu(3.9 + 5.0 + 3.0),
					Ram:     models.CalcVmTotalRamMiB(990 + 990 + 540),
					Storage: models.CalcVmTotalStorGiB(15 + 15 + 35),
				},
				models.IaasVm{
					...
					Cloud:   "NOKIA4",
					VCpu:    models.CalcVmTotalVcpu(5.0 + 4.0 + 2.0),
					Ram:     models.CalcVmTotalRamMiB(660 + 990 + 540),
					Storage: models.CalcVmTotalStorGiB(6 + 15 + 15),
				},
			},
			expectedCloudAfter: asmodel.Cloud{
				...
				Resources: models.ResourceStatus{
					...
					InUse: models.ResSet{
						VCpu:    26 + models.CalcVmTotalVcpu(2.4+1.4+5.0) + models.CalcVmTotalVcpu(3.9+5.0+3.0) + models.CalcVmTotalVcpu(5.0+4.0+2.0),
						Ram:     59392 + models.CalcVmTotalRamMiB(1024+990+660) + models.CalcVmTotalRamMiB(990+990+540) + models.CalcVmTotalRamMiB(660+990+540),
						Storage: 629 + models.CalcVmTotalStorGiB(10+15+6) + models.CalcVmTotalStorGiB(15+15+35) + models.CalcVmTotalStorGiB(6+15+15),
						Vm:      -1,
						Port:    -1,
						Volume:  -1,
					},
